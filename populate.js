...
const products = [
  { "_id" : new ObjectId("5e6d3081d112f70dc19772e2"), "name" : "AC3 Phone", "brand" : "ACME", "type" : ["phone"], "price" : 200, "rating" : 3.8,"warranty_years" : 1, "available" : true, "accessories": [new ObjectId("507d95d5719dbef170f15bf9"), new ObjectId("507d95d5719dbef170f15bfa"), new ObjectId("507d95d5719dbef170f15bfc"), new ObjectId("507d95d5719dbef170f15bfd") ], "services": [ new ObjectId("507d95d5719dbef170f15bfb"), new ObjectId("507d95d5719dbef170f15bfe"), new ObjectId("507d95d5719dbef170f15bff"), new ObjectId("507d95d5719dbef170f15c00")] },
  { "_id" : new ObjectId("5e6d3081d112f70dc19772e3"), "name" : "AC7 Phone", "brand" : "ACME", "type" : ["phone"], "price" : 320, "rating" : 4,"warranty_years" : 1, "available" : false,  "services": [ new ObjectId("507d95d5719dbef170f15bfb"), new ObjectId("507d95d5719dbef170f15bfe"), new ObjectId("507d95d5719dbef170f15bff"), new ObjectId("507d95d5719dbef170f15c00")] },
];
...
module.exports = async function populateDB() {
  try {
    ...
    const accessoryCol = db.collection('accessories');
    const servicesCol = db.collection('services');
    await cleanup(productsCol, accessoryCol, servicesCol)
    await productsCol.insertMany(products);
    await accessoryCol.insertMany(accessories);
